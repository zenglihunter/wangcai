...
def build_cards(posts: list[dict]) -> str:
    ...
    for post in posts:
        ...
        card = f"""        <a href="./{post['url']}" class="post-card" itemscope itemtype="https://schema.org/BlogPosting">
          <div class="post-date"><time datetime="{published_iso}" itemprop="datePublished">{published}</time></div>
